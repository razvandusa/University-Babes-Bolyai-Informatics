...
public:
    ...
    */
     ...
     */
    VectorDinamic<Disciplina> filtrare_discipline(VectorDinamic<Disciplina>& lista_discipline, std::string camp_filtrare, const std::string& criteriu);
     ...
     */
    void sortare_discipline(VectorDinamic<Disciplina>& lista_discipline, const std::string& criteriu);
private:
